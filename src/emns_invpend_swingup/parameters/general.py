"""
Physical parameters for the magnetic inverted pendulum system.

The system consists of a two-link inverted pendulum (actuator arm + pendulum arm)
manipulated by an external magnetic field (Navion or JECB platform). The actuator
arm carries a permanent magnet assembly; both arms rotate about a shared pivot joint.
State: [alpha, phi, alphaD, phiD] where alpha is the actuator angle and phi the
pendulum angle, both measured from vertical.
"""
import numpy as np
